<template>
   ...
   <div v-if="!$route.params.slug" class="py-5 max-w-5xl m-auto">
     ...
     <div id="cards-container" class="grid grid-cols-2 gap-5 sm:grid-cols-3">
       <template v-for="(post, index) in posts" :key="post.title">
         <div 
          v-if="index !== 0" 
          id="card" 
          class="max-w-sm font-sans p-4 relative border text-black border-gray-100 rounded-sm hover:shadow-sm hover:shadow-black ">
          ...
          <div class="my-4">
              <img class="w-full h-24 object-cover" :src="post.thumbnail" alt="">
          </div>
